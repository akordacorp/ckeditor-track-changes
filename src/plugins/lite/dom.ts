...
dom.isEmptyString = function(str: string) {
  if (!str) {
    return true;
  }
...
dom.getKeyChar = function(e: any) {
  return String.fromCharCode(e.which);
};
dom.getClass = function(className: string, startElement: any, tagName: string) {
  if (!startElement) {
...
dom.getId = function(id: string, startElement: any) {
  if (!startElement) {
    startElement = document;
  }
  return startElement.getElementById(id);
};
dom.getTag = function(tagName: string, startElement: any) {
  if (!startElement) {
    startElement = document;
  }
  return $.makeArray($(startElement).find(tagName));
};
dom.getElementWidth = function(element: any) {
  return element.offsetWidth;
};
dom.getElementHeight = function(element: any) {
  return element.offsetHeight;
};
dom.getElementDimensions = function(element: any) {
  return {
...
dom.insertAfter = function(after: any, elem: any) {
  if (after && elem) {
...
//	 <div><p> para </p><ul><li> hi </li></ul></div>
dom.removeWhitespace = function(element: any) {
  $(element)
    .contents()
    .filter(function() {
 ...
 */
dom.getNode = function(node: any, selector: any) {
  if (!node) return null;
...
dom.getParents = function(elements: any, filter: any, stopEl: any) {
...
dom.hasBlockChildren = function(parent: HTMLElement) {
...
dom.removeTag = function(element: any, selector: any) {
  $(element)
    .find(selector)
...
dom.stripEnclosingTags = function(content: any, allowedTags: any) {
  var c = $(content);
  c.find('*')
    .not(allowedTags)
    .replaceWith(function() {
...
dom.getSiblings = function(element: any, dir: any, elementNodesOnly: any, stopElem: any) {
...
dom.getNodeTextContent = function(node: any) {
  return $(node).text();
};
dom.getNodeStubContent = function(node: any) {
  return $(node).find(stubElementsString);
};
dom.hasNoTextOrStubContent = function(node: any) {
  var str = dom.getNodeTextContent(node);
  if (!dom.isEmptyString(str)) {
    return false;
  }
  if (!node.firstChild) {
    // no children shortcut
    return true;
  }
  return $(node).find(stubElementsString).length === 0;
};

dom.isEmptyTextNode = function(node: any) {
...
dom.getNodeCharacterLength = function(node: any) {
  return dom.getNodeTextContent(node).length + $(node).find(dom.STUB_ELEMENTS.join(', ')).length;
};
dom.setNodeTextContent = function(node: any, txt: string) {
  return $(node).text(txt);
};
dom.getTagName = function(node: any) {
  return (node && node.tagName && node.tagName.toLowerCase()) || null;
};
dom.getIframeDocument = function(iframe: any) {
  var doc = null;
...
dom.isChildOf = function(el: any, parent: any) {
  try {
...
dom.isChildOfTagName = function(el: any, name: any) {
  try {
    while (el && el.parentNode) {
...
dom.isChildOfTagNames = function(el: any, names: any) {
  try {
    while (el && el.parentNode) {
...
dom.isChildOfClassName = function(el: any, name: any) {
  try {
    while (el && el.parentNode) {
...
dom.replaceWith = function(node: any, replacement: any) {
  return $(node).replaceWith(replacement);
};
dom.getElementsBetween = function(fromElem: any, toElem: any) {
  var elements: any = [];
  if (fromElem === toElem) {
    return elements;
  }
...
dom.getCommonAncestor = function(a: any, b: any) {
  var node = a;
  while (node) {
...
dom.getNextContentNode = function(node: any, container: any) {
  if (node) {
    while (node.parentNode) {
      if (node === container) {
        return null;
...
dom.getPrevNode = function(node: any, container: any) {
  if (node) {
    while (node.parentNode) {
      if (node === container) {
        return null;
...
dom.getPrevContentNode = function(node: any, container: any) {
  if (node) {
    while (node.parentNode) {
      if (node === container) {
        return null;
...
function _findNextTextContainer(node: any, container?: any): any {
  while (node) {
...
function _findPrevTextContainer(node: any, container?: any): any {
  while (node) {
    if (dom.TEXT_NODE == node.nodeType) {
      return node;
    }
...
dom.findPrevTextContainer = function(node: any, container: any): any {
...
dom.findNextTextContainer = function(node: any, container: any) {
  if (!node || node == container) {
    return {
      node: container,
...
dom.getNodeLength = function(node: any) {
  return node
...
dom.isTextContainer = function(node: any) {
  return (
    (node && dom.TEXT_NODE == node.nodeType) ||
    dom.TEXT_CONTAINER_ELEMENTS.indexOf((node.nodeName || '').toLowerCase()) >= 0
  );
};

dom.getNodeIndex = function(node: any) {
  var i = 0;
...
dom.canContainTextElement = function(element: any) {
...
dom.getFirstChild = function(node: any) {
  if (node.firstChild) {
...
dom.getLastChild = function(node: any) {
  if (node.lastChild) {
...
dom.removeEmptyNodes = function(parent: any, callback: any) {
...
dom.create = function(html: any) {
  return $(html)[0];
};
dom.children = function(parent: any, exp: any) {
  return $(parent).children(exp);
};
dom.parent = function(child: any, exp: any) {
  return $(child).parent(exp)[0];
};
dom.parents = function(child: any, exp: any) {
  return $(child).parents(exp);
};
dom.walk = function(elem: any, callback: any, lvl: any) {
  if (!elem) {
    return;
  }
  if (!lvl) {
...
dom.revWalk = function(elem: any, callback: any) {
  if (!elem) {
    return;
  }
...
dom.setStyle = function(element: any, property: any, value: any) {
  if (element) {
    $(element).css(property, value);
  }
};
dom.getStyle = function(element: any, property: any) {
  return $(element).css(property);
};
dom.hasClass = function(element: any, className: any) {
  return $(element).hasClass(className);
};
dom.addClass = function(element: any, classNames: any) {
  $(element).addClass(classNames);
};
dom.removeClass = function(element: any, classNames: any) {
  $(element).removeClass(classNames);
};
dom.preventDefault = function(e: any) {
  e.preventDefault();
  dom.stopPropagation(e);
};
dom.stopPropagation = function(e: any) {
  e.stopPropagation();
};

dom.isBlank = function(value: any) {
  return !value || wsrgx.test(value);
};
dom.isFn = function(f: any) {
  return typeof f === 'function';
};
dom.isObj = function(v: any) {
  return v !== null && typeof v === 'object';
};
dom.isset = function(v: any) {
  return typeof v !== 'undefined' && v !== null;
};
dom.isArray = function(v: any) {
  return $.isArray(v);
};

dom.isNumeric = function(str: string) {
...
dom.inArray = function(needle: any, haystack: any) {
...
dom.arrayDiff = function(array1: any, array2: any, firstOnly: any) {
...
dom.arrayMerge = function(array1: any, array2: any) {
  var c = array2.length,
    i;
  for (i = 0; i < c; i++) {
 ...
 */
dom.stripTags = function(content: any, allowedTags: any) {
...
dom.isBrowser = function(browser: any) {
  return dom.browser().type === browser;
};

dom.getBlockParent = function(node: any, container: any) {
...
dom.findNodeParent = function(node: any, selector: any, container: any) {
  if (node) {
    while (node.parentNode) {
      if (node === container) {
        return null;
...
dom.onBlockBoundary = function(leftContainer: any, rightContainer: any, blockEls: any) {
  ...
  var sBlocks = blockEls.join(', '),
    bleft =
      ...
      ($(leftContainer).is(sBlocks) && leftContainer) ||
      null,
    bright =
      dom.isChildOfTagNames(rightContainer, blockEls) ||
      ($(rightContainer).is(sBlocks) && rightContainer) ||
      null;
  return bleft !== bright;
};

dom.isOnBlockBoundary = function(leftContainer: any, rightContainer: any, container: any) {
  if (!leftContainer || !rightContainer) {
    return false;
  }
  var bleft =
...
dom.mergeContainers = function(node: any, mergeToNode: any) {
  if (!node || !mergeToNode) {
    return false;
  }
...
dom.mergeBlockWithSibling = function(range: any, block: any, next: any) {
  var siblingBlock = next
    ? $(block)
        .next()
        .get(0)
    : $(block)
        .prev()
        .get(0); // block['nextSibling'] : block['previousSibling'];
...
dom.date = function(format: any, timestamp: any, tsIso8601: any) {
...
dom.getOrdinalSuffix = function(number: number) {
  var suffix = '';
  var tmp = number % 100;
  if (tmp >= 4 && tmp <= 20) {
    suffix = 'th';
...
dom.addNumberPadding = function(number: any) {
  if (number < 10) {
    number = '0' + number;
  }
  return number;
};
dom.tsIso8601ToTimestamp = function(tsIso8601: any) {
...
dom.normalizeNode = function(node: any, ignoreNative: boolean) {
  if (!node) {
    return;
  }
...
function _myNormalizeNode(node: any) {
  if (!node) {
    return;
  }
  var ELEMENT_NODE = 1;

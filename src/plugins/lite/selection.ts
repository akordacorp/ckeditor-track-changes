...
class Selection {
  ...
  _initializeRangeLibrary() {
    ...
    var move = function(range: any, unitType: any, units: any, isStart: any) {
      if (units === 0) {
        return;
      }
     ...
     */
    rangy.rangePrototype.moveStart = function(unitType: any, units: any) {
     ...
     * number of `units`.
     */
    rangy.rangePrototype.moveEnd = function(unitType: any, units: any) {
     ...
     */
    rangy.rangePrototype.setRange = function(start: any, container: any, offset: any) {
      if (start) {
     ...
     */
    rangy.rangePrototype.moveCharLeft = function(moveStart: any, units: any) {
     ...
     */
    rangy.rangePrototype.moveCharRight = function(moveStart: any, units: any) {
      var container, offset;
     ...
     */
    rangy.rangePrototype.getNextContainer = function(container: any, skippedBlockEl: any) {
      if (!container) {
        return null;
      }
      ...
      while (container.nextSibling) {
        ...
        if (container.nodeType !== dom.TEXT_NODE) {
      ...
      if (this.isSelectable(container) === true) {
        return container;
      } else if (dom.isBlockElement(container) === true) {
     ...
     */
    rangy.rangePrototype.getPreviousContainer = function(container: any, skippedBlockEl: any) {
      if (!container) {
        return null;
      }
      skippedBlockEl = skippedBlockEl || [];
      ...
      while (container.previousSibling) {
        ...
        if (container.nodeType !== dom.TEXT_NODE) {
          if (dom.isStubElement(container) === true) {
            return container;
          } else {
    ...
    rangy.rangePrototype.getNextTextNode = function(container: any) {
      if (container.nodeType === dom.ELEMENT_NODE) {
    ...
    rangy.rangePrototype.getPreviousTextNode = function(container: any, skippedBlockEl: any) {
    ...
    rangy.rangePrototype.getFirstSelectableChild = function(element: any) {
      if (!element) {
        return null;
      }
    ...
    rangy.rangePrototype.getLastSelectableChild = function(element: any) {
      if (!element) {
        return null;
      }
      if (element.nodeType == dom.TEXT_NODE) {
    ...
    rangy.rangePrototype.isSelectable = function(container: any) {
      return Boolean(
        container && container.nodeType === dom.TEXT_NODE && container.data.length !== 0
      );
    };

    rangy.rangePrototype.getHTMLContents = function(clonedSelection: any) {
      if (!clonedSelection) {
